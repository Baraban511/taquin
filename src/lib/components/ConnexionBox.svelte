...
<div class="border-2 dark:border-gray-700 m-5 rounded">
            ...
            <div class="relative z-auto">
              ...
              >
                {#if password === "password"}
                  ...
                  />
                {:else}
                  <TablerEyeOff class="dark:text-white text-xl" />
                {/if}</button
              >
            </div>
          </div>
  ...
  {#if data?.step === "QCM"}
    <div transition:slide class="p-5 mb-5">
      ...
      >
        <fieldset class="flex justify-center items-center flex-wrap gap-4">
          {#each data.qcm.answers as answer, i (answer)}
            <div>
              <label
                for="radio{i}"
      ...
      >
        ...
        >
          <img
            ...
            src={googleCalendar}
          />
          <h3 class="text-lg font-medium">S'abonner avec Google Calendar</h3>
          <p class="text-gray-500 dark:text-gray-400">
            Vous pouvez automatiquement exporter ce calendrier vers le Google
            Calendar.
          </p>
          <a
        ...
        >
          ...
          <p class="text-gray-500 dark:text-gray-400">
            Exporter ce calendrier vers le Calendrier iOS, Outlook, Proton, etc.
          </p>
          <div class="flex max-w-full">
            ...
            <button
              ...
              ><TablerCheck class="{clipboard ? '' : 'hidden'} h-5 w-5 mr-3" />
